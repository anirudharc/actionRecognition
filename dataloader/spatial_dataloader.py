...
class spatial_dataloader():
    ...
    def load_frame_count(self):
        ...
        with open('/home/ubuntu/two-stream-action-recognition/dataloader/dic/frame_count.pickle','rb') as file:
...
if __name__ == '__main__':
    ...
    dataloader = spatial_dataloader(BATCH_SIZE=1, num_workers=1, 
                                path='/home/ubuntu/dataset/UCF101/jpegs_256/', 
                                ucf_list='/home/ubuntu/two-stream-action-recognition/UCF_list/',
                                ucf_split='01')
